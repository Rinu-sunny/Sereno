  ...
  if (!authChecked) return <HomeSkeleton />;
      ...
      <div className="max-w-6xl mx-auto text-center space-y-4 py-20">
        ...
        <div className="space-y-4 animate-fade-in">
          ...
          <Link
            to="/timer"
            className="inline-block px-8 py-2 bg-primary text-primary-foreground rounded-full text-lg font-semibold hover:bg-primary/90 transition-all hover:scale-105 shadow-lg hover:shadow-xl"
          >
            Start Your Session
          </Link>
        </div>
